...
export default function AboutSection() {
  ...
  return (
    <section id="hakkinda" className="bg-[#030308] relative" aria-label={a.sectionTag}>
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="text-[#7c3aed] text-xs uppercase mb-4 flex items-center gap-2" style={{ letterSpacing: '0.2em' }}>
            ...
            <p className="text-gray-400 leading-relaxed mb-4">{a.p1}</p>
            <p className="text-gray-500 leading-relaxed mb-8">{a.p2}</p>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                style={{ background: 'linear-gradient(135deg, #6d28d9, #3b82f6)', boxShadow: '0 0 20px rgba(99,102,241,0.35)' }}
              >
                {a.cta1}
          ...
          >
            ...
            >
              <div className="relative">
                ...
                <div className="absolute -top-1 -right-1 w-3 h-3 rounded-sm rotate-12" style={{ background: '#3b82f6', filter: 'blur(4px)', opacity: 0.8 }} />
              </div>
              <div>
                <p className="text-white text-2xl font-bold" style={{ letterSpacing: '0.15em' }}>Kuyumcu</p>
                <p className="text-gray-500 text-sm mt-0.5">{a.appDesc}</p>
              </div>
            </div>
              ...
              {STATS.map((val, i) => (
                ...
                >
                  <p
                    ...
                    style={{ background: 'linear-gradient(135deg, #7c3aed, #3b82f6)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}
                  >
                    {val}
                  </p>
                  <p className="text-gray-500 text-sm">{a.statsLabel[i]}</p>
                </motion.div>
              ))}
            </div>
