...
export default function CryptoDashboard() {
  ...
  return (
    <section id="kripto" className="bg-[#030308] relative">
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 py-24">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-12">
          <div>
            <div
              className="text-[#3b82f6] text-xs uppercase mb-3 flex items-center gap-2"
            ...
            <p className="text-gray-500 mt-2">
              Piyasa değerine göre ilk 12 kripto para — her dakika güncellenir
            </p>
          </div>
        ...
        {status === 'loading' && (
          <div className="flex items-center justify-center py-32 gap-3 text-gray-500">
            ...
            <span>CoinGecko'dan veri çekiliyor...</span>
          </div>
        )}
        ...
        {status === 'error' && (
          <div className="flex flex-col items-center justify-center py-32 gap-4 text-gray-500">
            <p>Kripto verisi yüklenemedi.</p>
            <button
              onClick={refetch}
              className="px-4 py-2 rounded-full border border-white/10 text-sm hover:text-white transition-colors"
            >
              Tekrar Dene
            </button>
          </div>
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{
                      background: `radial-gradient(ellipse at top right, ${isPos ? 'rgba(59,130,246,0.05)' : 'rgba(239,68,68,0.04)'} 0%, transparent 60%)`,
                    }}
                  />
                  ...
                  <div className="relative z-10">
                    <p className="text-gray-500 text-xs uppercase tracking-widest mb-1">Fiyat</p>
                  ...
                  <div className="grid grid-cols-2 gap-2 relative z-10">
                    <div className="rounded-xl p-2.5" style={{ background: 'rgba(255,255,255,0.03)' }}>
                      <p className="text-gray-500 text-xs mb-1">24s Yüksek</p>
                      <p className="text-emerald-400 text-xs font-medium">{formatUSD(coin.high_24h)}</p>
                    </div>
                    <div className="rounded-xl p-2.5" style={{ background: 'rgba(255,255,255,0.03)' }}>
                      <p className="text-gray-500 text-xs mb-1">24s Düşük</p>
